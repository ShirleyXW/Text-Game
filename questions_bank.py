# Questions from https://opentdb.com/api.php?amount=25&category=17&type=multiple&difficulty=easy

NATURE_SCIENCE_QUESTIONS = (
    {
...
# Questions from https://opentdb.com/api.php?amount=25&category=18&type=multiple&difficulty=easy
COMPUTER_QUESTIONS = (
    {
    ...
    {
        "question": "The series of the Intel HD graphics generation succeeding that of the 5000 and 6000 series "
                    "(Broadwell) is called:",
...
# Questions from https://opentdb.com/api.php?amount=25&category=22&type=multiple&difficulty=easy
GEOGRAPHY_QUESTIONS = (
    {
    ...
    {
        "question": "The derisive acronym \"PIIGS\" refers to which of the following European countries and their "
                    "economic statuses?",
